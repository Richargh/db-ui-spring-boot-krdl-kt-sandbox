 ...
 */var registerFocusRestoreDialog = function () {
    ...
    var registered = new WeakMap;// store previous focused node centrally
    ...
    return function registerFocusRestoreDialog(dialog) {
        ...
        registered.set(dialog, null);// replace showModal method directly, to save focus
        var realShowModal = dialog.showModal;
        dialog.showModal = function () {
            var savedFocus = document.activeElement;
            if (savedFocus === document || savedFocus === document.body) {// some browsers read activeElement as body
        ...
        var mo = new MutationObserver(function () {
            ...
            } else {// if open was cleared/set in the same frame, then the dialog will still be a modal (Y)
            }
        });
